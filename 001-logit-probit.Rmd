...
Thus, we know that the regression coeficients of $\beta_i$ actually change the "log-odds" of the event. Of course, note that the magnitude of $\beta_i$ is dependent upon the units of $x_i$. But, in general, log-odds can be in the range of $-\infty +\infty$ .
